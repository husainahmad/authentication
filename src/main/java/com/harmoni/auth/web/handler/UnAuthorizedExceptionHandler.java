...
import com.harmoni.auth.application.exception.BusinessUnAuthorizedRequestException;
...
public class UnAuthorizedExceptionHandler {
    ...
    public ResponseEntity<CommonDto> handleUnAuthorizedException(BusinessUnAuthorizedRequestException e, Locale locale) {
